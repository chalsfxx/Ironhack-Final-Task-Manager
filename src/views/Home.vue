<template>
  ...
  <div class="container-fluid justify-content-between text-center mt-4 mb-4">
    <div class="row text-center">
      <div class="col-sm">
        <NewTask @getTasks="getTasks" />
      </div>
    </div>
    <h2 class="mt-5 mb-4 container-fluid justify-content-between text-center">
      Tasks
    </h2>
  
      <div class="row text-center mw-50">
        <TaskItem
          @getTasks="getTasks"
...
const toogleTask = async (id) => {
  tasks.value = await taskStore.fetchTasks();
  // tasks.is_complete.value = await taskStore.
};
toogleTask();
...
// variable to to save the profile from supabase
...
const getProfile = async () => {
  ...
  // we save the profile in a variable
